...
class VeriFactiTestCase(TransactionCase):
    ...
    def setUp(self):
        ...
        self.company.write({
            ...
            'account_fiscal_country_id': self.env.ref('base.es').id,  # Requerido en Odoo 18+ para validación de impuestos
        })
        ...
        # En Odoo 16+: usar account_type en lugar de user_type_id
        # En Odoo 18+: account.account ya no tiene company_id
        ...
        if not self.tax:
            # En Odoo 17+, tax_group_id es obligatorio
            ...
            self.tax = self.env['account.tax'].create({
                ...
                'tax_group_id': tax_group.id,  # Requerido en Odoo 17+
            })
    ...
    def create_test_invoice(self, invoice_type='out_invoice', state='draft', **kwargs):
        ...
        """
        invoice_vals = {
            'move_type': invoice_type,  # Odoo 14+ usa move_type
