...
class TestAccountMove(VeriFactiTestCase):
    ...
    def test_parse_invoice_number(self):
        ...
        # Forzar nombre de factura (año dinamico: debe coincidir con
        # invoice_date o la constraint de secuencia de Odoo lo rechaza)
        year = invoice.invoice_date.year
        invoice.name = f'INV/{year}/0001'
    ...
    def test_invoice_types(self):
        ...
        self.assertEqual(invoice_out.move_type, 'out_invoice')
