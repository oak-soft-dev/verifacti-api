# -*- coding: utf-8 -*-
{
    ...
    'description': """
        ...
        **¡Prepárate para VeriFactu 2026!** 🇪🇸
        ...
        💰 Licencia y Precio
        --------------------
        **COMPLETAMENTE GRATUITO** - Licencia LGPL-3
    ...
    'maintainer': 'Oak Soft',
    'support': 'oak.soft@telefonica.net',
    'license': 'LGPL-3',
    'price': 0.00,
    'currency': 'EUR',
    ...
    'data': [
        ...
        'views/verifacti_api_config_views.xml',
        'views/verifacti_supplier_views.xml',
        'views/verifacti_customer_views.xml',
        'views/verifacti_invoice_views.xml',
        'views/verifacti_invoice_line_views.xml',
