...
### 2. Configurar Proveedores en Odoo

1. Ir a: **Verifacti > Configuración > Proveedores**
2. Hacer clic en **Crear**
3. Configurar cada proveedor/emisor:
   - **Nombre**: Nombre o razón social del emisor
   - **NIF/CIF**: NIF del emisor (debe coincidir con el registrado en Verifacti)
   - **API Key de Verifacti**: API Key obtenida de Verifacti para ese NIF específico
   - **Entorno**: Test o Producción
   - **URL de la API**: Dejar por defecto (`https://api.verifacti.com`)
...
LGPL-3 - Completamente gratuito y open source
